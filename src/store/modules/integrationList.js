    ...
    "oneOf": [
      {
        ...
        "then": {
          "properties": {
            ...
            "max_requeue": {
              "type": "integer",
              "title": "Max Fails to Requeue)",
              "default": 0,
              "description": "Set How Many Time To Requeue A Requests Do To Target Error",
              "minimum": 0
            }
          }
        }
        ...
        "then": {
          "properties": {
            ...
            "visibility_timeout_seconds": {
              ...
              "default": 3600,
              "description": "Set Long To Set Visibility In Seconds To Keep The Message During Processing",
              "minimum": 0
            },
            "wait_timeout": {
              "type": "integer",
        ...
        "then": {
          "properties": {
            ...
            "max_receive_count": {
              ...
              "default": 0,
              "description": "Set Queue Message Max Fails Retries Route To Dead-Letter",
              "minimum": 0,
              "maximum": 2147483647
            }
          }
